  ...
  <div id="app" class="shell">
    ...
    <main class="main">
      ...
      <div class="content">
        ...
        <section id="page-control" class="page subpage control-page" hidden>
          <div class="control-deck">
            <div class="control-titlebar">
              <button class="control-home" type="button" onclick="showPage('overview')">返回首页</button>
              <div class="control-title">双足机器人导览系统</div>
              <div class="tech-status">网络正常&nbsp;&nbsp;电量 92%</div>
            </div>
