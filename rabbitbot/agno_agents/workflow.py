...
DOCX_SCRIPT_POINTS = {
    ...
    "点位3": {
        "summary": "点位3",
        "description": "DOCX 剧本拿取咖啡和合作成果介绍点位。",
        "location": [
            {"x": 6.5727, "y": -7.1909, "z": 0.1151, "ox": -0.0016, "oy": 0.0294, "oz": -0.6045, "ow": -0.7961, "mode": 1},
        ],
    },
    "点位4": {
        "summary": "点位4",
    ...
    "点位5": {
        "summary": "点位5",
        "description": "DOCX 剧本告别并指引小巴方向点位；先经过点位4和4->5过渡点位，再到达点位5终点。",
        "location": [
            {"x": 13.9410, "y": -5.1633, "z": 0.0350, "ox": 0.0140, "oy": 0.0335, "oz": -0.9085, "ow": -0.4163, "mode": 1, "note": "点位4中转"},
