...
export STT_VAD_SPEECH_THRES=${STT_VAD_SPEECH_THRES:-0.20}
export STT_VAD_START_HITS=${STT_VAD_START_HITS:-2}
export STT_MIN_RMS=${STT_MIN_RMS:-0.045}
export STT_MIN_UTTERANCE_SEC=${STT_MIN_UTTERANCE_SEC:-0.55}
...
export STT_INPUT_GAIN=${STT_INPUT_GAIN:-0.75}
