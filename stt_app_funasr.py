...
VAD_SPEECH_THRES = float(os.environ.get("STT_VAD_SPEECH_THRES", "0.20"))
VAD_START_HITS = int(os.environ.get("STT_VAD_START_HITS", "2"))
MIN_RMS = float(os.environ.get("STT_MIN_RMS", "0.045"))
MIN_UTTERANCE_SEC = float(os.environ.get("STT_MIN_UTTERANCE_SEC", "0.55"))
