...
exec docker exec "${docker_exec_args[@]}" \
    ...
    -e RABBITBOT_QA_GUIDE_TRIGGER_PHRASES="${RABBITBOT_QA_GUIDE_TRIGGER_PHRASES:-开始导览}" \
    -e RABBITBOT_QA_GUIDE_COMMAND_FILE="${RABBITBOT_QA_GUIDE_COMMAND_FILE:-${CONTAINER_RABBITBOT_DIR}/runtime/nav_workflow_control/command}" \
    -e RABBITBOT_QA_GUIDE_STATE_FILE="${RABBITBOT_QA_GUIDE_STATE_FILE:-${CONTAINER_RABBITBOT_DIR}/runtime/nav_workflow_control/guide_state}" \
    -e RABBITBOT_QA_GUIDE_START_TIMEOUT_SECONDS="${RABBITBOT_QA_GUIDE_START_TIMEOUT_SECONDS:-90}" \
    -e RABBITBOT_QA_GUIDE_FINISH_TIMEOUT_SECONDS="${RABBITBOT_QA_GUIDE_FINISH_TIMEOUT_SECONDS:-1200}" \
