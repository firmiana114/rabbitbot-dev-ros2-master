...
#   容器 navid-vllm-cuda-mic-audio:/data/rabbitbot-dev-ros2-master/logs/rabbitbot_stt.log
...
LOG_FILE="${STT_LOG_FILE:-/data/rabbitbot-dev-ros2-master/logs/rabbitbot_stt.log}"
