...
start_tts() {
    ...
    start_background "TTS" "${LOG_DIR}/rabbitbot_tts.log" bash -lc "cd '${PROJECT_DIR}' && export RABBITBOT_TTS_BACKEND='${RABBITBOT_TTS_BACKEND}' && export RABBITBOT_PREFERRED_LOCAL_TTS_DEVICE='${RABBITBOT_PREFERRED_LOCAL_TTS_DEVICE:-REDMI Speaker 2-6002}' && export TTS_DEVICE_NAME='${TTS_DEVICE_NAME:-REDMI Speaker 2-6002}' && export RABBITBOT_UNITREE_TTS_INTERFACE='${RABBITBOT_UNITREE_TTS_INTERFACE}' && export RABBITBOT_UNITREE_TTS_VOLUME='${RABBITBOT_UNITREE_TTS_VOLUME}' && export RABBITBOT_UNITREE_TTS_SPEAKER_ID='${RABBITBOT_UNITREE_TTS_SPEAKER_ID}' && export RABBITBOT_UNITREE_TTS_TIMEOUT='${RABBITBOT_UNITREE_TTS_TIMEOUT}' && export RABBITBOT_UNITREE_TTS_SET_VOLUME_EACH_REQUEST='${RABBITBOT_UNITREE_TTS_SET_VOLUME_EACH_REQUEST}' && export RABBITBOT_UNITREE_TTS_REQUIRE_CARRIER='${RABBITBOT_UNITREE_TTS_REQUIRE_CARRIER}' && export RABBITBOT_UNITREE_TTS_REQUIRE_IPV4='${RABBITBOT_UNITREE_TTS_REQUIRE_IPV4}' && export RABBITBOT_UNITREE_TTS_AUTO_PROBE='${RABBITBOT_UNITREE_TTS_AUTO_PROBE}' && export RABBITBOT_UNITREE_TTS_PROBE_TIMEOUT='${RABBITBOT_UNITREE_TTS_PROBE_TIMEOUT}' && export RABBITBOT_TTS_DEVICE=\${RABBITBOT_UNIFIED_TTS_DEVICE:-cuda} && export RABBITBOT_TTS_FAST_SOUND_PRELOAD=\${RABBITBOT_UNIFIED_TTS_FAST_SOUND_PRELOAD:-0} && export RABBITBOT_TTS_STARTUP_SPEECH=\${RABBITBOT_UNIFIED_TTS_STARTUP_SPEECH:-0} && bash scripts/start_tts_app.bash"
